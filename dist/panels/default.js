...
const editor = ">=3.4.0";
const scripts = {
  "build:panels:dev": "cross-env NODE_ENV=development node scripts/panels.js",
  "build:main:dev": "cross-env NODE_ENV=development node scripts/main.js",
  "build:scene:dev": "cross-env NODE_ENV=development babel src/scene/index.ts --out-file dist/scene/index.js"
};
var packageJSON = {
  package_version,
  version,
...
const PositionProp = vue.defineComponent({
  ...
  setup(props) {
    ...
    return () => vue.createVNode("div", {
      ...
      "class": "pos__field"
    }, [vue.createVNode("span", null, [vue.createTextVNode("x: ")]), vue.createVNode(vue.resolveComponent("ui-num-input"), {
      "class": "pos__input",
      "ref": xInputRef,
      "step": "0.1",
      "value": position.x,
      ...
      "class": "pos__field"
    }, [vue.createVNode("span", null, [vue.createTextVNode("y: ")]), vue.createVNode(vue.resolveComponent("ui-num-input"), {
      ...
      "class": "pos__field"
    }, [vue.createVNode("span", null, [vue.createTextVNode("z: ")]), vue.createVNode(vue.resolveComponent("ui-num-input"), {
      "className": "pos__input",
      "ref": zInputRef,
      "step": "0.1",
      "value": position.z,
